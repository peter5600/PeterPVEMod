...
import net.peter.peterpvemod.item.Custom.RadioItem;
...
public class ModItem {
    ...
    public static final RegistryObject<Item> RADIO = ITEMS.register("radio", () -> new RadioItem(new Item.Properties().stacksTo(1).tab(ModCreativeModTab.PETER_PVE_MOD_TAB)));
